...
public class ThreeDayDownTrend extends IndicatorPlugin {
	
	public static final RGB DEFAULT_COLOR = new RGB(200, 0, 0);
    public static final String DEFAULT_LABEL = "3 Day Down Trend"; //$NON-NLS-1$
